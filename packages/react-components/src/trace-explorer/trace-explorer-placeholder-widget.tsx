...
export class ReactExplorerPlaceholderWidget extends React.Component<ReactPlaceholderWidgetProps, {}> {
    ...
    render(): React.JSX.Element {
        ...
        const infoText = serverOn ? 'You have not yet opened a trace.' : 'No trace server instance is currently running.';
        const buttonText = serverOn ? 'Select a trace to open' : 'Start trace server';
